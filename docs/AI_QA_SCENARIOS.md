...
| SC-APP-12 | docs-site | lazy home payload, sidebar/drawer nav, desktop/mobile scroll-spy TOC, route/section focus, Ctrl+K palette, copy/code toggle, four add-on pages | browser |
