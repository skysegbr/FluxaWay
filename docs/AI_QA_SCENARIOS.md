...
| SC-APP-12 | docs-site | lazy home payload, sidebar/drawer nav, keyboard menu with all 20 published examples, desktop/mobile scroll-spy TOC, route/section focus, Ctrl+K palette including CSS, eight CSS guides, five add-on pages | browser |
