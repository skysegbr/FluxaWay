export const ARCHITECTURE_FRAMES = [
  {
    ...
    data: {
      kind: "cover",
      eyebrow: "FluxaWay 0.8.0 | A View for Architects",
      heading: "A complete frontend framework, without the build chain",
      body: "FluxaWay is an ESM-native JavaScript framework for building real applications straight in the browser. A runtime with VDOM, hooks, context, routing and SSR, plus a design system with 61 components. All of it with no bundler, no JSX and no mandatory build step.",
  ...
  },
  {
    ...
    data: {
      ...
      layers: [
        { name: "dist/fluxaway.js", role: "VDOM, render, hooks, context, routing and SSR hydration" },
        { name: "dist/fluxaway-components.js", role: "61 production-ready UI components on top of h()" },
        { name: "dist/fluxaway-ui.css", role: "tokens, grid, dark mode, mobile shell and utilities" },
        { name: "dist/fluxaway-server.js", role: "renderToString(App) for SEO and first paint" },
  ...
  },
  {
    ...
    data: {
      ...
      body: "FluxaWay makes a deliberate choice: components called by h() execute immediately. This keeps the runtime lean and rendering predictable, even in large applications, as long as context and composition follow the contracts below.",
      decisions: [
  ...
  },
  {
    ...
    data: {
      ...
      body: "For architects, the decision goes beyond the technical: it is how you govern versions, security, cache and production environments. FluxaWay keeps these choices explicit instead of hidden in the build.",
      layers: [
  ...
  },
  {
    ...
    data: {
      ...
      heading: "FluxaWay trades tooling abstraction for operational clarity",
      body: "The gain shows up when the value is in transparent delivery, simple governance and direct execution in the browser. FluxaWay does not give up capability: it sustains complete applications, but it requires module and ownership discipline instead of a build to enforce structure.",
      decisions: [
  ...
  },
  {
    ...
    data: {
      ...
      heading: "A FluxaWay application is standard JavaScript",
...
render(App, document.getElementById("app"));`,
  ...
  },
  {
    ...
    data: {
      ...
      heading: "FluxaWay as a long-term architectural decision",
      columns: [
        {
  ...
  },
  {
    ...
    data: {
      kind: "cover",
      eyebrow: "Closing",
      heading: "The question is not whether FluxaWay can handle it. It is where it becomes an advantage.",
      body: "FluxaWay is a complete framework for architectures that value operational simplicity, transparent delivery and direct composition in the browser, from the first component to the application in production.",
      meta: ["Validate", "Standardize", "Scale by domain"],
      hint: "Next step: Grow with FluxaWay!",
    },
  },
];
