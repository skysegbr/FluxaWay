...
Then open `http://localhost:8000/examples/palate-journey/`.

## Photography

All photographs are stored locally and are free to use under the Unsplash License:

- Aperitivo — Andrea Riezzo: https://unsplash.com/photos/clear-drinking-glass-with-orange-liquid-and-ice-1hKZ0A182Bk
- Garden — Anda Ambrosini: https://unsplash.com/photos/bunch-of-tomatoes-UOEB1ztsDMo
...
- Nightcap — Hybrid Storytellers: https://unsplash.com/photos/a-cocktail-with-cherries-and-orange-peel-on-a-bar-oyaeXz5OZCY
