/*!
 * FluxaWay — development-time hot reload client.
 *
 ...
 */
// FluxaWay live-reload client — add to HTML ONLY in development.
...
(function () {
  ...
  function connect() {
    ...
    es.onopen = function () {
      console.log("[FluxaWay HMR] connected");
    };
    ...
    es.onmessage = function (e) {
      try {
        ...
        if (msg.type === "reload") {
          console.log("[FluxaWay HMR] reloading due to: " + msg.path);
