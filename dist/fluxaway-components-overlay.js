/*!
 * FluxaWay — UI component library, `overlay` category: overlays (Dialog, Drawer, Menu, Popover, Toast, CommandPalette, ...).
...
import { focusFirstElement, focusFirstElementIfOutside, hasChildren, joinClasses, moveMenuFocus, trapFocus } from "./fluxaway-components-util.js";
...
export function Tooltip({
  ...
  // FluxaWay evaluates function components eagerly (h() calls them immediately),
