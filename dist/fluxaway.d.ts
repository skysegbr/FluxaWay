/*!
 * FluxaWay — TypeScript declarations for the core runtime.
 ...
 */
/**
 * Type declarations for /dist/fluxaway.js
 *
 * Generated from the real runtime source — every signature here matches an
 * actual `export function` or `export const` in fluxaway.js.
 */
...
/**
 * A virtual DOM node returned by h() or a FluxaWay component.
 *
 * FluxaWay evaluates h(Component, props) eagerly — the component function runs
...
/** Any FluxaWay component function. */
...
/**
 * Unmount the FluxaWay tree rooted at `container` and run all effect cleanups.
 */
 ...
 * Opt-in — FluxaWay never rewrites URLs automatically.
 *
 * @example
 ...
 *
 * Also exported from `dist/fluxaway-server.js`.
 *
 * @example
